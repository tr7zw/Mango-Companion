...
public class BilibilicomicsTest extends TestCase {
    ...
    public void testName() throws IOException {
        Parser parser = new Bilibilicomics();
        assertEquals("Forced to Be a Princess After Reincarnating in Another World", parser.getName("https://www.bilibilicomics.com/detail/mc113"));
    }
    
    public void testChapters() throws IOException {
        Parser parser = new Bilibilicomics();
        Iterator<Chapter> iterator = parser.getChapters(new EmptyFileChecker(), "https://www.bilibilicomics.com/detail/mc113");
