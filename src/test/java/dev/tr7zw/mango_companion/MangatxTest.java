...
public class MangatxTest extends TestCase {
    ...
    public void testName() throws IOException {
        Parser parser = new Mangatx();
        assertEquals("The Player that can’t Level Up", parser.getName("https://mangatx.com/manga/the-player-that-cant-level-up/"));
    }
    
    public void testChapters() throws IOException {
        Parser parser = new Mangatx();
        Iterator<Chapter> iterator = parser.getChapters(new EmptyFileChecker(), "https://mangatx.com/manga/reformation-of-the-deadbeat-noble/"); // Different manga because the other one has broken images
