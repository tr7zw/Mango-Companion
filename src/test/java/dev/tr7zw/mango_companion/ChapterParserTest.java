...
public class ChapterParserTest extends TestCase {
    ...
    public void testUrls() {
        assertEquals(
                "180.1",
                ChapterParser.getChapterId("https://example.com/manga/manga-name/chapter-180-1/"));
        assertEquals(
                "180.123",
                ChapterParser.getChapterId(
                        "https://example.com/manga/manga-name/chapter-180-123/"));
        assertEquals(
                "180",
                ChapterParser.getChapterId("https://example.com/manga/manga-name/chapter-180/"));
        assertEquals(
                "123",
                ChapterParser.getChapterId("https://example.com/manga/manga-name/chapter-123/"));
        assertEquals(
                "180.1",
                ChapterParser.getChapterId("https://example.com/manga/manga-name/ch-180-1/"));
        assertEquals(
                "180.123",
                ChapterParser.getChapterId("https://example.com/manga/manga-name/ch-180-123/"));
        assertEquals(
                "180", ChapterParser.getChapterId("https://example.com/manga/manga-name/ch-180/"));
        assertEquals(
                "123", ChapterParser.getChapterId("https://example.com/manga/manga-name/ch-123/"));
    }
