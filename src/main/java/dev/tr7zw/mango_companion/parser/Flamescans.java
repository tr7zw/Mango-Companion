...
public class Flamescans extends StandardLayoutParser {
  ...
  @Getter private Pattern uriPattern = Pattern.compile("https?://flamescans.org/series/.+");

  @Getter
  private Pattern mangaUriUUIDPattern =
      Pattern.compile("https?://flamescans.org/series/([a-z-0-9]+)");
  ...
  private FlamescansAPI flamescansApi =
      Feign.builder()
  ...
  private StandardLayoutApi api =
      APIProxyBuilder.getProxy(flamescansApi::getMangaInfo, flamescansApi::getChapterPage);
